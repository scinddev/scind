...
| 4 | 04-tls-support.md | A-2 | PRD, Technical Spec | Medium | Design decision needed |
| 5 | 05-go-stack-missing-commands.md | M-2, M-3, M-4, M-5, C-2 | CLI Reference, Go Stack | Medium | Multiple scaffolds needed |
| 6 | 06-template-variables.md | A-3, A-4 | PRD, Technical Spec | Small | Documentation clarity |
