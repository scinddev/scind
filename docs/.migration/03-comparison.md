...
Extract the product comparison content showing how Contrail relates to alternative tools.

**Source document**: `specs/contrail-prd.md` lines 317-393 (Comparison with Alternatives section)

---

## File: `product/comparison.md`

**Source**: `specs/contrail-prd.md:317-393`
